...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className="flex justify-center items-center  md:py-20 py-10 xl:px-0"
    >
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="expText flex xl:gap-20 md:gap-10 gap-5 relative z-20">
                      ...
                      <div>
                        ...
                        <p className="my-5 text-white-100">
                          🗓️&nbsp;{card.date}
                        </p>
                        <p className="text-[#839CB5] italic">
                          Responsibilities
                        </p>
                        <ul className="list-disc ms-5 mt-5 flex flex-col gap-5 text-white-100">
