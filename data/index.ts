...
>>>>>>> 1da11da113bbae3c09615f9d2f025dfd4c32b4ff
  ...
  {
    review:
      "Dear Hisham, I just wanted to sincerely thank you for the amazing work you did on designing my application logo. I truly appreciate your creativity, attention to detail, and the effort you put into making a design that perfectly reflects the vision of my project. The final result exceeded my expectations, and I’m really happy with it. I look forward to working with you again in the future._Abdulhamid Sultan The founder of Ejaza app",
    imgPath: "/freelancer-1.svg",
    logoPath: "freelancer-1.svg",
    title: "Freelance Frontend Developer",
    date: "2022 - Present",
    responsibilities: [
      "Built a feature-rich e-commerce store using React, Bootstrap, and Axios, integrating multiple payment methods.",
      "Developed a movie browser app using React and the TMDB API, with real-time updates and Context API for state management.",
      "Showcased projects using HTML5, CSS3, JavaScript, and Bootstrap in a personal portfolio.",
    ],
  },
  {
    review:
      "",
    imgPath: "/FCI.png", // تقدر تحط أي أيقونة مناسبة
    logoPath: "/FCI.png",
    title: "Faculty of Computers & Artificial Intelligence - Benha University",
    date: "2019 - 2023",
    responsibilities: [
      "Gained in-depth knowledge in computer science, software engineering, and artificial intelligence.",
      "Worked on academic and personal projects involving web development ",
...
export const expLogos = [
  {
    name: "EITS",
    imgPath: "/Logoicon (1).svg", // Changed path
  },
  {
    name: "Cosmic Coasters",
    imgPath: "/as_logo.svg", // Changed path
  },
  {
    name: "freelancer",
    imgPath: "/freelancer-1.svg", // Changed path
  },
];
...
export const gridItems = [
  {
    ...
    description: "A complete visualization of a residential villa using Lumion Pro, focusing on natural lighting and realistic materials.",
  ...
  },
  {
    ...
    description: "An office designed from scratch in SketchUp and rendered with V-Ray.",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
...
export const projects = [
  {
    ...
    des: "A website for a building management system company based in Egypt, built with React, Three.js, and Framer Motion.",
  ...
  },
  {
    ...
    des: "A website for a rocketry engineering team based in vienna, Austria , built with React, Three.js, and Framer Motion.",
...
export const testimonials = [
  {
    quote:
      "I would like to express my sincere thanks and appreciation to Eng. HESHAM. Since his very first day working on this project... he has shown great dedication in highlighting all aspects of the company and shedding light on everything important that represents our values. I foresee a bright future for you, God willing. You are a true example of dedication and creativity and your presence is a genuine asset to our team.",
  ...
  {
    quote:
      "We are all really pleased with Hisham’s work. The codebase is now well-structured and styled, and we’d much rather continue building on his work than on the old one. We would be very happy to keep collaborating with him on further additions.",
    name: "Fabian Maier",
  ...
  {
    quote: "والله يا هشام أنا كنت عارف إنك هتطلع الشغل اللي في دماغي بالظبط عشان كدا انت اصلا اول حد جه ف بالي لإني عارف شغلك وجودته.. فألف شكر يا فنان ويارب مزيد من التوفيق",
    name: "Othman Nour",
